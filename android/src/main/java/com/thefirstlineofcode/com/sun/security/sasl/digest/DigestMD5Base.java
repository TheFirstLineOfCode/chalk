...
import com.thefirstlineofcode.com.sun.security.sasl.util.AbstractSaslImpl;
...
abstract class DigestMD5Base extends AbstractSaslImpl {
     ...
     *
     * @param digest non-null byte array
                ...
                if (msgLength < 0) {
                    ...
                    if (logger.isLoggable(Level.INFO)) {
                        logger.log(Level.INFO,
                                ...
                                Byte.valueOf(msgWithPadding[msgWithPadding.length - 1]));
                    }
                    return EMPTY_BYTE_ARRAY;
                }
            }
