package com.thefirstlineofcode.chalk.android.logger;
...
public class LogConfigurator {
	...
	public void configure(String dataDir, String appName, LogLevel logLevel) {
		if (dataDir == null)
			throw new IllegalArgumentException("Null data dir.");
		
		System.setProperty(PROPERTY_KEY_DATA_DIR, dataDir);
